...
async function loadWorker() {
  ...
  wrapper_msg.innerHTML = '<span style="font-size:15px; margin-top:5px;">Connecting to sqlite httpvfs database...</span><div class="loader"><div>';
  window.worker = await (0,sql_js_httpvfs__WEBPACK_IMPORTED_MODULE_0__.createDbWorker)(
    [
      {
        from: "inline",
        config: {
          serverMode: "full",
          url: "https://raw.githubusercontent.com/jiangjy-713/AL_Index/master/data/journal.db",
          // url: "../../data/journal.db",
  ...
  wrapper_msg.innerHTML = '<span style="font-size:15px; margin-top:5px;">Database connected</span>';
...
/******/ })()
;
//# sourceMappingURL=DBload_bundle.js.map